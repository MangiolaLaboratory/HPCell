...
#calculate proportion and plot
  ...
  dplyr::count(Tissue, all_of(params$x5), scDblFinder.class, name= "count_class") |> 
    group_by(Tissue, all_of(params$x5)) |> 
  ...
  #plot proportion
  ggplot(aes(x = all_of(params$x5) , y = proportion, fill = scDblFinder.class)) +

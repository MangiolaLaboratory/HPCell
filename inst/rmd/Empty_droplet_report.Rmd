...
- Shows the distribution of reads with varying percentages of mitochondrial content 
- Cut off threshold classifies reads as being high mitochondria 
```{r,  warning=FALSE, message=FALSE, echo=FALSE}
...
- In droplet-based scRNA-seq technologies, like the 10X Genomics platform, not all droplets contain cells. Some droplets are empty, while others might contain ambient RNA or debris, leading to ambiguous reads. 
- The MA plot shows the distribution of total RNA counts so that we can set thresholds to filter out both true empty and ambiguous droplets. 

...
empty_df <- function(meta_data, empty_droplets_tbl) {
  input <- meta_data |> 
    tibble::rownames_to_column(var = '.cell')
...
process_empty_droplet_list <- purrr::map2(meta_data, params$x2, empty_df)
...
#   plot_mito_data(x1[[i]], sample_names[[i]], params$x3[[i]])
# })
# 

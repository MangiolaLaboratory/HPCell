...
#' @param x A variable to aggregate by, typically a batch or sample identifier.
...
#' @param create_pseudobulk_sample: A list of `SummarizedExperiment` objects representing pseudobulk samples

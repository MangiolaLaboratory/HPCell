...
doublet_identification<-function(code_directory,input_path_demultiplexed,reference_label,input_path_empty_droplets,input_path_alive,input_path_annotation_label_transfer,output_path){
  # Create dir
